...
<body >
	...
	<div class="header" >
		...
		<h1 id="big-title" style="color: red;">${article.title}</h1>
		<h2 id="time" style=" margin-top: -157px; margin-left: 614px;color: yellow;">${article.updateTime}</h2>
	</div>
	<!-- 主要内容 -->
	<div id="content">
		<div class="block" style="border-radius:6px 6px 0 0;">
			<div class="grid-1-2-1" style="margin-right: 180px;">
				...
				<div id="main-content" style="min-width: 950px;margin-top: 100px;margin-bottom: 40px;">
					<div>
						<h4 style="color: #3c4858;padding-left: 10px;color:purple;">文章类型：${article.name}</h4>
						<p style="color: green;text-align: right;">浏览量：${nViewCount}</p>
					</div>
