...
<body >
	...
	<div class="header" >
		...
		<h2 id="time" style=" margin-top: -157px; margin-left: 614px;color: white;">${article.updateTime}</h2>
	</div>
	<!-- 主要内容 -->
	<div id="content">
		<div class="block" style="border-radius:6px 6px 0 0;">
			<div class="grid-1-2-1" style="margin-right: 180px;">
				...
				<div id="main-content" style="min-width: 950px;margin-top: 100px;margin-bottom: 40px;">
					<div>
					<h2 style="text-align: center">QQ：2522991658</h2>
					<h2 style="text-align: center">微信：luo18868227731</h2>
					</div>
				</div>
