					...
					<div class="list-content">
						...
						<div class="block">
							...
							<div class="main" style="margin-bottom: 100px;">
								<input type="radio" class="fill" name="radio" value="restore"/>恢复文章
								<br/>
								<br/>
								<input type="radio" class="fill" name="radio" value="remove"/>彻底删除
								<br/>
								<button id="submit" class="button green" style="margin-top: 20px"><span class="icon-check">确定</button>
							</div>
						</div>
					</div>
				</div>
